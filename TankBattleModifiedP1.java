...
public class TankBattleModifiedP1 {
...
// ------------------------------------------------------------------------------------
        ...
        ServerSocket ss = new ServerSocket(7345);
...
// ------------------------------------------------------------------------
        ...
        window.setTitle("--Tank Battle-- player 1");
        ...
        while (true) {
            ...
            // PLAYER 1 FIREING MOVEMENT IN  GAMECONTROL-------------------------------------------------------
    ...
    public static String incrypt(GameControl gameControl){
        ...
        for(int i=0 ; i<=6 ; i++){
            ...
            if(i==0){
                ...
                if(gameControl.p1up){tempStr="1";}
                if(gameControl.p1right){tempStr="2";}
                if(gameControl.p1down){tempStr="3";}
                if(gameControl.p1left){tempStr="4";}
            }
...
// SIGNAL FORMAT--------------------------------
// playerCoordinateX, playerCoordinateY, playerFiring, playerFireCordinateX, playerFireCordinateY, playerDirection,